...
app.get('/api/endpoints', api.list);
app.get('/api/endpoint/:id', api.get);
...
new Moonboots({
    moonboots: {
        jsFileName: 'support-dashboard',
        cssFileName: 'support-dashboard',
...
console.log('Support Dashboard is running at: http://localhost:' + config.http.port + ' Yep. That\'s pretty awesome.');
